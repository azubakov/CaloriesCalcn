 ...
 */
public class AddVegetablesProductsDialogFragment extends DialogFragment {
    EditText etProduct;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_add_vegetables_product_dialog, container, false);
    ...
    private void saveTodoToFirebase() {
        ...
        VegetablesProducts milkproducts = new VegetablesProducts(product,calorieshundredgramm);

        ref.push().setValue(milkproducts);
        dismiss();
    }
}
