 ...
 */
public class AddPopularProductsDialogFragment extends DialogFragment {
    EditText etProduct;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_add_bread_product_dialog, container, false);
    ...
    private void saveTodoToFirebase() {
        ...
        PopularProducts milkproducts = new PopularProducts(product, calorieshundredgramm);
