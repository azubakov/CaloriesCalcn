 ...
 */
public class AddFishProductsDialogFragment extends DialogFragment {
    EditText etProduct;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_add_meat_product_dialog, container, false);
    ...
    private void saveTodoToFirebase() {
        ...
        MilkProducts milkproducts = new MilkProducts(product, calorieshundredgramm);
