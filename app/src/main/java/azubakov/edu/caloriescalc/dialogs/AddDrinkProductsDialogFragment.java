 ...
 */
public class AddDrinkProductsDialogFragment extends DialogFragment {
    EditText etProduct;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_add_drink_product_dialog, container, false);
    ...
    private void saveTodoToFirebase() {
        ...
        DrinkProducts drinkproducts = new DrinkProducts(product,calorieshundredgramm);

        ref.push().setValue(drinkproducts);
        dismiss();
    }
}
