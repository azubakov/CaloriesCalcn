 ...
 */
public class AddActsProductsDialogFragment extends DialogFragment {
    EditText etProduct;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_add_acts_product_dialog, container, false);
    ...
    private void saveTodoToFirebase() {
        ...
        ActsProducts actskproducts = new ActsProducts(product,calorieshundredgramm);

        ref.push().setValue(actskproducts);
        dismiss();
    }
}
