...
public class RecyclerMilkProductsActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_recycle_milk_products);
...
/*        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
    ...
    private void initRecycler() {
        //find View By Id:
        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.milkproductsRecycler);
        ...
        MilkProductsRecyclerAdapter adapter = new MilkProductsRecyclerAdapter(ref);
    ...
    public void addMessages(View view) {
        AddMilkProductsDialogFragment fragment =
                new AddMilkProductsDialogFragment();

        fragment.show(
                getSupportFragmentManager(),
                "AddMilkProductDialog"
        );
    }
