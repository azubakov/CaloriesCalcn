...
public class CaloriesDetailsBasicActivity extends AppCompatActivity {
    ...
    public void SaveFirabase(View view) {
        ...
        String genderStr = etGender.getText().toString();
        ...
        String activityStr = etActivity.getText().toString();
        Integer activity = Integer.valueOf(genderStr);


        Body body = new Body(date, gender, weight, age, height, activity);
