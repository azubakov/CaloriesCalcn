...
public class ResultInfoBodyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_result_info_body);
      ...
      /*  FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        ...
        //int gender = (genderstring == null || genderstring.trim().equals("") ? 0 : Integer.parseInt(genderstring));
    ...
    public void Calculate() {
        ...
        Body body = new Body(date, gender, weight, age, height, activity, bmi,
                             s2, HarBenCarOld, HarBenCarNew, MiflinCar, AvrCal,
                             MaxCal, MaxCal, Slim, ExtraSlim, Fat, ExtraFat);
        //Weight weight = new Weight(weightDoub);
 ...
 /*   public void SaveFirabase1(View view) {
        FirebaseUser currentUser = FirebaseAuth.getInstance().getCurrentUser();
        ...
        Body body = new Body(date, gender, weight, age, height, activity, Slim, ExtraSlim, Fat, ExtraFat);

        //Weight weight = new Weight(weightDoub);

        ref.push().setValue(body);
        Toast.makeText(ResultInfoBodyActivity.this, "The value is saved", Toast.LENGTH_SHORT).show();
        dismiss();
